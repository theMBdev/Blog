...
$sql = "SELECT title FROM blog WHERE userid=".$urlID."";
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="leftcolumn">
                        <?php  
                        $sql = "SELECT id, title, body FROM posts WHERE userid=".$urlID." ORDER BY id DESC";        
                        $result = mysqli_query($mysqli,$sql);  
                    ...
                    <div class="rightcolumn">
                        <div class="card">
                            <h2>About Me</h2>
                            <?php 
                            $sql = "SELECT name FROM users WHERE id=".$urlID."";
                        ...
                        <div class="card">
                            ...
                            <?php 
                            $sql = "SELECT description FROM blog WHERE userid=".$urlID."";  
